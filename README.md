...
Opera можно заменить в /usr/lib/x86_64-linux-gnu/ но тогда гит хаб перестает редактироваться , значит придётся так пока пользоваться пока не выпустят вот такую opera как я дал с поддержкой html5 и допилят поддержку git или вы можете проверить вот эту мою новую версию opera на поддержку html5 https://www87.zippyshare.com/v/pIkII0jV/file.html
